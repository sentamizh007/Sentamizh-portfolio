...
import profilePicDark from "../../assets/projects/profiledark.png";
import profilePicLight from "../../assets/projects/profilelight.png";
  ...
  return (
    ...
    animate-pulse`}
                ...
                <motion.img
                  ...
                  animate={{ x: 0, opacity: 1 }}
                  transition={{ duration: 1, delay: 1.5 }}
                  className={`relative  z-10 mt-[-60px] md:mt-[10px] w-[200px] h-[200px] lg:w-[400px] lg:h-[400px] rounded-full shadow-2xl object-fit  border-4 ${
                    theme === "dark" ? "border-yellow-200" : "border-cyan-200"
                  }`}
                />
              </motion.div>
            </div>
          ...
          <div className="w-full lg:w-1/2 px-7">
            ...
            >
              ...
              <motion.span
                variants={ChildVariants}
                className="bg-gradient-to-r from-stone-300 to-stone-600 bg-clip-text text-2xl lg:text-5xl tracking-light text-transparent"
              >
                <TypeAnimation
                  sequence={[
                    "Web Developer </>",
              ...
              <motion.p
                variants={ChildVariants}
                className={` py-3  text-md mt-2 mb-2 lg:text-md  text-center md:text-left  ${
                  theme === "dark"
              ...
              <div className=" mb-[40px] flex items-center justify-center gap-4 text-2xl md:text-4xl sm:gap-7">
                <a
                  href="https://www.linkedin.com/in/sentamizhselvan-s-3b90b2287/"
                  target="_blank"
                ...
                <a
                  href=" https://github.com/sentamizh007"
                  target="_blank"
                  className={` ${
                    theme === "dark" ? "text-white" : "text-black"
                  } `}
              ...
              <div className="flex items-center gap-2">
                <motion.a
                  ...
                  className={`rounded shadow-xl p-4 lg:px-10 font-extrabold text-[12px]  mb-10 ${
                    theme === "dark"
                      ? "bg-[#fcea4c] border-2 text-black shadow-xl rounded-md border-white    "
                      : "bg-cyan-400 text-white border-2 shadow-xl rounded-md border-white "
                  }`}
                >
                  Download CV
                </motion.a>
