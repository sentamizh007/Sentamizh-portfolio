...
import aboutImg from "../../assets/projects/aboutdark.png";
import aboutImglight from "../../assets/projects/aboutlight.png";
...
const About = ({ theme }) => {
    ...
    const stats = [
  { label: " Fresher ", description: "" },
  { label: "3+ Projects ", description: "Completed"},
  { label: " Java, AWS, React-Native", description: "Learning" },
];
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-16  py-12  md:px-[100px] px-1  ">
        ...
        <div className="flex-shrink-0 ">
          <img
            ...
            alt="Profile"
            className="rounded-lg shadow-lg p-5 hover:p-4 transition-all duration-500 w-full lg:w-[500px] "
          />
        </div>
        ...
        <div className="max-w-4xl text-center md:text-left">
          ...
          >
            IAM Sentamizhselvan and I'm a MERN STACK Developer
          </h1>
